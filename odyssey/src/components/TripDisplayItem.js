...
function TripDisplayItem(props) {
  ...
  return (
    <div className={"tripDisplayCard"}>
      <MapDisplay mapOptions={props.mapOptions} markers={props.markers}>
      </MapDisplay>
      <div className="descriptionContainer">
        <h1><b>Trip Title</b></h1>
        <p>Trip Description: alsdkfjlaksdf asdif asdif aisd fidkle id kei dkllelalsdkfjlaksdf asdif asdif aisd fidkle id kei dkllelalsdkfjlaksdf asdif asdif aisd fidkle id kei dkllelalsdkfjlaksdf asdif asdif aisd fidkle id kei dkllelalsdkfjlaksdf asdif asdif aisd fidkle id kei dkllelalsdkfjlaksdf asdif asdif aisd fidkle id kei dkllelalsdkfjlaksdf asdif asdif aisd fidkle id kei dkllelalsdkfjlaksdf asdif asdif aisd fidkle id kei dkllel
        </p>
